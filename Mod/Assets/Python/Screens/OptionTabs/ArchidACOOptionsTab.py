...
class ArchidACOOptionsTab(BugOptionsTab.BugOptionsTab):
	"Archid ACO Options Screen Tab"
	...
	def create(self, screen):
		...
		self.addTextDropdown(screen, rightL, rightR, "ACO__ShowDefenceModifiers")
		self.addTextDropdown(screen, rightL, rightR, "ACO__ShowTotalDefenceModifier")
