...
public:
	...
	int getGlobalWarmingIndex() const;
	int getGlobalWarmingChances() const;
	int getGwEventTally() const;
	int calculateGlobalPollution() const;
	int calculateGwLandDefence(int /* PlayerTypes */ ePlayer) const;
	int calculateGwSustainabilityThreshold(int /* PlayerTypes */ ePlayer) const;
