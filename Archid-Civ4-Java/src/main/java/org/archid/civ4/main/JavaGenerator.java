...
public class JavaGenerator {
	...
	private void setDefaults(String tag) {
		if (tag.equals("Civ4BonusInfos")) {
			props.setAppProperty(PropertyKeys.PROPERTY_KEY_MOD_SCHEMA_DIR, "E:\\Projects\\Civ4\\github\\Civ4-AB-Mod\\mod\\Assets\\Xml\\Terrain");
			...
			props.setAppProperty(PropertyKeys.PROPERTY_KEY_MOD_SCHEMA_DIR, "E:\\Projects\\Civ4\\github\\Civ4-AB-Mod\\mod\\Assets\\Xml\\Buildings");
